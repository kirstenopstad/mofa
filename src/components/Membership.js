...
const Membership = () => {
  ...
  return(
    <div className="membership">
      ...
      <p>{prompt}</p>
      <h1>Membership</h1>
      <p>MoFA is a wep application built to provoke conversations around using AI to generate art.</p>
      <p>Memberships support the ongoing development of fake art.</p>
